...
namespace CLEANSHOP.Models
{
    ...
    partial void InsertTypeShoe(TypeShoe instance);
    partial void UpdateTypeShoe(TypeShoe instance);
    partial void DeleteTypeShoe(TypeShoe instance);
    ...
    partial void DeleteType(Type instance);
		...
		public System.Data.Linq.Table<TypeShoe> TypeShoes
		{
			get
			{
				return this.GetTable<TypeShoe>();
			}
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TypeShoes")]
	public partial class TypeShoe : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _ID_TypeShoes;
		
		private string _Name_TypeShoes;
    ...
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnID_TypeShoesChanging(int value);
    partial void OnID_TypeShoesChanged();
    partial void OnName_TypeShoesChanging(string value);
    partial void OnName_TypeShoesChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ID_TypeShoes", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int ID_TypeShoes
		{
			get
			{
				return this._ID_TypeShoes;
			}
			set
			{
				if ((this._ID_TypeShoes != value))
				{
					this.OnID_TypeShoesChanging(value);
					this.SendPropertyChanging();
					this._ID_TypeShoes = value;
					this.SendPropertyChanged("ID_TypeShoes");
					this.OnID_TypeShoesChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Name_TypeShoes", DbType="NVarChar(50)")]
		public string Name_TypeShoes
		{
			get
			{
				return this._Name_TypeShoes;
			}
			set
			{
				if ((this._Name_TypeShoes != value))
				{
					this.OnName_TypeShoesChanging(value);
					this.SendPropertyChanging();
					this._Name_TypeShoes = value;
					this.SendPropertyChanged("Name_TypeShoes");
					this.OnName_TypeShoesChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TypeShoe_Product", Storage="_Products", ThisKey="ID_TypeShoes", OtherKey="ID_Shoes")]
		...
		{
			this.SendPropertyChanging();
			entity.TypeShoe = this;
		}
		
		private void detach_Products(Product entity)
		{
			this.SendPropertyChanging();
			entity.TypeShoe = null;
		}
	}
	...
	public partial class Customer : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _forgotpasscode;
    ...
    partial void OnforgotpasscodeChanging(string value);
    partial void OnforgotpasscodeChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_forgotpasscode", DbType="NVarChar(50)")]
		public string forgotpasscode
		{
			get
			{
				return this._forgotpasscode;
			}
			set
			{
				if ((this._forgotpasscode != value))
				{
					this.OnforgotpasscodeChanging(value);
					this.SendPropertyChanging();
					this._forgotpasscode = value;
					this.SendPropertyChanged("forgotpasscode");
					this.OnforgotpasscodeChanged();
				}
			}
		}
	...
	public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _ID_Shoes;
		
		private EntitySet<CartDetail> _CartDetails;
		
		private EntityRef<TypeShoe> _TypeShoe;
    ...
    partial void OnID_ShoesChanging(System.Nullable<int> value);
    partial void OnID_ShoesChanged();
    #endregion
		
		public Product()
		{
			this._CartDetails = new EntitySet<CartDetail>(new Action<CartDetail>(this.attach_CartDetails), new Action<CartDetail>(this.detach_CartDetails));
			this._TypeShoe = default(EntityRef<TypeShoe>);
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_ID_Shoes", DbType="Int")]
		public System.Nullable<int> ID_Shoes
		{
			get
			{
				return this._ID_Shoes;
			}
			set
			{
				if ((this._ID_Shoes != value))
				{
					if (this._TypeShoe.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnID_ShoesChanging(value);
					this.SendPropertyChanging();
					this._ID_Shoes = value;
					this.SendPropertyChanged("ID_Shoes");
					this.OnID_ShoesChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="TypeShoe_Product", Storage="_TypeShoe", ThisKey="ID_Shoes", OtherKey="ID_TypeShoes", IsForeignKey=true)]
		public TypeShoe TypeShoe
		{
			get
			{
				return this._TypeShoe.Entity;
			}
			set
			{
				TypeShoe previousValue = this._TypeShoe.Entity;
				if (((previousValue != value) 
							|| (this._TypeShoe.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._TypeShoe.Entity = null;
						previousValue.Products.Remove(this);
					}
					this._TypeShoe.Entity = value;
					if ((value != null))
					{
						value.Products.Add(this);
						this._ID_Shoes = value.ID_TypeShoes;
					}
					else
					{
						this._ID_Shoes = default(Nullable<int>);
					}
					this.SendPropertyChanged("TypeShoe");
				}
			}
		}
